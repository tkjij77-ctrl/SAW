-- SAW MC Hosting v2.0.0-beta.13 complete database upgrade
...
-- ============================================================================
-- BETA12 FINAL BACKEND + DEPLOYMENT MIGRATION
-- ============================================================================
-- SAW MC Hosting v2.0.0-beta.7 feature and audit-retention migration
begin;

alter table public.servers
  alter column template_version set default '2.9.0';
